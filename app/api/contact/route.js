...
export async function POST(request) {
    ...
    try {
        await resend.emails.send({
            from: 'RehabPulse Data Request <onboarding@resend.dev>',
            ...
            html: `
                <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#1a1a1a;">
                    ...
                    <p style="margin-top:0;color:#666;font-size:13px;">Submitted via RehabPulse Ghana Portal</p>
                    ...
                    <table style="width:100%;border-collapse:collapse;font-size:14px;">
                        ...
                        <tr><td style="padding:8px 0;color:#666;">Email</td><td style="padding:8px 0;"><a href="mailto:${email}" style="color:#10b981;">${email}</a></td></tr>
